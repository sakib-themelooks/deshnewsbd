...
@section('css-top')
	<link href="{{asset('backend/backend/assets')}}/node_modules/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css" />
...
#reporter-lists .active{background: #f8f9fa;}
</style>
@endsection
@section('content')
    <!-- Page wrapper  -->
                    ...
                    <div class="card m-b-0">
                        ...
                        <div class="chat-main-box">
                            ...
                            <div class="chat-left-aside">
                                ...
                                <div class="chat-left-inner">
                                    <div class="form-material">
                                        <input class="form-control p-2 search" id="reporterKey" onkeyup="myFunction()" type="text" placeholder="Search Contact">
                                    </div>
                                    <ul class="chatonline style-none contacts" id="reporter-lists">
                                        <li>
                                            <a onclick="message(2)" style="display: flex;" href="javascript:void(0)">
                                            	<div class="avatar dot-status online-active">
                                            		<img src="{{asset('backend/assets')}}/images/users/2074581346.jpg" alt="reporter-img" class="img-circle">
                                            	</div>
                                            	<div class="content">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)"><img src="{{asset('backend/assets')}}/images/users/1673487498.jpg" alt="reporter-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)"><img src="{{asset('backend/assets')}}/images/users/2074581346.jpg" alt="reporter-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)"><img src="{{asset('backend/assets')}}/images/users/1673487498.jpg" alt="reporter-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                        </li>
                            ...
                            <div class="chat-right-aside conversation-history">
                                @include('common.message.conversations')
                            </div>
                            <!-- .chat-right-panel -->
                        </div>
                        <!-- /.chat-row -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="parent_id" class="select2 form-control custom-select">
                                                ...
                                                @foreach($reporters as $reporter)
                                                    <option value="{{$reporter->id}}">{{$reporter->user->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
@endsection
@section('js')
    <script src="{{asset('backend/backend/assets')}}/node_modules/select2/dist/js/select2.full.min.js" type="text/javascript"></script>
    <script src="{{asset('backend/js')}}/pages/chat.js"></script>
	<script>
    ...
    <script type="text/javascript">
       $(".select2").select2();
        function myFunction() {
            ...
            input = document.getElementById("reporterKey");
            filter = input.value.toUpperCase();
            ul = document.getElementById("reporter-lists");
