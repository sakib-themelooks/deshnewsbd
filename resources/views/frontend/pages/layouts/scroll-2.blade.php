            ...
            <a class="col-md-{{$section_item->colxs}} col-xs-12 mmb pps" href="{{route('newsDetails', [$recent->slug, $recent->id])}}">
                ...
                <div class="col-md-4 col-xs-4 imix pps videos">
                    ...
                    @elseif(Config::get('siteSetting.lazyload'))
                        @if($recent->image)
                            <img class="lazyload" src="{{ asset('upload/images/default.jpg')}}" data-src="{{ asset('upload/images/thumb_img/'. $recent->image->source_path)}}"  alt="{{$recent->news_title}}">
                        @else
        ...
        <div class="tab-pane " id="nexup2">
            ...
            <a class="col-md-{{$section_item->colxs}} col-xs-12 mmb pps" href="{{route('newsDetails', [$popular->slug, $popular->id])}}">
                ...
                <div class="col-md-4 col-xs-4 imix pps videos">
                    ...
                    @elseif(Config::get('siteSetting.lazyload'))
                        @if($popular->image)
                            <img class="lazyload" src="{{ asset('upload/images/default.jpg')}}" data-src="{{ asset('upload/images/thumb_img/'. $popular->image->source_path)}}"  alt="{{$popular->news_title}}">
                        @else
