<div class="{{$section_item->colmd}} pps" style="display: flex;align-items: center;flex-direction: row;position: fixed;bottom: 0;z-index: 9;background: {{$section_item->bg_text}};">
