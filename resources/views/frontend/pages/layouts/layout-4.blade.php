        ...
        @foreach($section_item->newsByCategory->take($section->item_number) as $index => $section_news)
            ...
            @if($index == 0)
                <div class="col-md-12 pps">
                    <a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}" class="news-post standard-post2 ppss">
            ...
            @else
                <a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}" class="col-md-12 col-xs-12 news-post standard-post24 pps">
