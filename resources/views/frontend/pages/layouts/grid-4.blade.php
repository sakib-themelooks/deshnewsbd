<div class="{{$section_item->colmd}} col-xs-12" style="margin:{{$section_item->margin}};padding:{{$section_item->padding}};">
    ...
    <div class="row mix1">
        ...
        <a class="mixsection_news_img col-md-{{$section_item->colxs}} col-xs-12 mmb" href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">
            <div class="col-md-12 col-xs-12 grid4_news_imgs pps videos">
