                                    ...
                                    <a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">
                                        <div class="post-gallery">
                                            ...
                                            @if($section_news->type == 3)
                                                <a class="play-link" href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}"><i class="fa fa-play-circle-o"></i></a>
                                        ...
                                        <div class="post-title box_title">
                                            <h2><a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">{{Str::limit($section_news->news_title, 90)}} </a></h2>
                                    ...
                                    <ul class="list-posts">
                                        <li>
                                            ...
                                            <div class="post-content">
                                                <h2><a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">{{Str::limit($section_news->news_title, 40)}}</a></h2>
                                ...
                                <div class="news-post standard-post2">
                                    <a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">
                                        ...
                                        <div class="post-title" style="padding: 6px 3px !important;">
                                            <h2><a href="{{route('newsDetails', [$section_news->getCategory->slug, $section_news->id])}}">{{Str::limit($section_news->news_title, 45)}} </a></h2>
