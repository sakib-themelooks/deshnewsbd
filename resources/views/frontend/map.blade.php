...
<div class="homePageSideSvg dnone-m">Hello01
<svg version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background:new -201 -372.5 560 776.5;" xml:space="preserve">
    ...
    <g id="rangpur">
        <a href="{{url('category')}}/deshjure/rangpur" xlink:href="{{url('category')}}/deshjure/rangpur">
    ...
    <g id="sylhet">
        <a href="{{url('category')}}/deshjure/sylhet" xlink:href="{{url('category')}}/deshjure/sylhet">
    ...
    <g id="khulna">
        <a href="{{url('category')}}/deshjure/khulna" xlink:href="{{url('category')}}/deshjure/khulna">
    ...
    <g id="dhaka">
        <a href="{{url('category')}}/deshjure/dhaka" xlink:href="{{url('category')}}/deshjure/dhaka">
...
l-0.6,0.1v2.8l2.5,0.5L87-94c0,0,1.5-0.7,1.8,0s2.4,1.3,2.4,1.3l0.8,2.2l0.2,2l0.4,2l0.7,7.2L87-82h-9h-9H51L49.4-95.6z"></path>
    ...
    <g id="mymensingh">
        <a href="{{url('category')}}/deshjure/mymensingh" xlink:href="{{url('category')}}/deshjure/mymensingh">
    ...
    <g id="rajshahi">
        <a href="{{url('category')}}/deshjure/rajshahi" xlink:href="{{url('category')}}/deshjure/rajshahi">
    ...
    <g id="borishal">
        <a href="{{url('category')}}/deshjure/barisal" xlink:href="{{url('category')}}/deshjure/barisal">
    ...
    <g id="chittagong">
        <a href="{{url('category')}}/deshjure/chittagong" xlink:href="{{url('category')}}/deshjure/chittagong">
