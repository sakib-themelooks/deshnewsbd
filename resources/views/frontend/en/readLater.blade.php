									...
									<div class="col-md-3 col-sm-4 col-xs-6">
										<div class="item news-post standard-post">
											<div class="post-gallery">
												...
												<a class="category-post sport" href="{{ route('category', [$show_news->news->categoryList->cat_slug_en]) }}">{{$show_news->news->categoryList->category_en}}</a>
											</div>
