...
if($section->section_type == 'category' || $section->section_type == 'country-wide'){
    ...
    $query->where('status', '=', 'active')->where('lang', '=', 'bd')->orderBy('id', 'desc'); }, 'newsByCategory.image', 'newsByCategory.getCategory:id,category_bd,category_en,cat_slug_en', 'newsByCategory.subcategoryList:id,subcategory_bd,subcategory_en']);
}   
