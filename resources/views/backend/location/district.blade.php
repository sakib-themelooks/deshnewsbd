                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name_bd}}</td>
                                               <!--  <td>{{$data->name_en}}</td> -->
                                                <td>@if($data->deshjureType){{$data->deshjureType->name_bd}}@endif </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button  class="btn btn-danger btn-sm" onclick="deleteConfirmPopup('{{ route("district.delete", $data->id)  }}')"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                            ...
                            <form action="{{route('district.store')}}" method="POST">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row justify-content-md-center">
                                       ...
                                       <div class="col-md-12">                           
                                            <div class="form-group">
                                                <label for="location">Division</label>
                                                <select name="parent_id" id="location" class="form-control custom-select">
                                                    @foreach($locations as $location)
                                                        <option value="{{$location->id}}" {{($location->id == old('location')) ?  'selected' : ''}}>{{$location->name_bd}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
