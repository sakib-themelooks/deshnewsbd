                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button  class="btn btn-danger btn-sm" onclick="deleteConfirmPopup('{{ route("upzilla.delete", $data->id)  }}')"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                @foreach($locations as $location)
                                                    <option value="{{$location->id}}">{{$location->name_bd}}</option>
                                                @endforeach
                                            </select>
                                            </div>
                                        </div>
