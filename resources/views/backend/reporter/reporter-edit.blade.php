        ...
        <div class="container-fluid" style="padding: 0 10px !important;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Edit Reporter </h4>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                   @if(Session::has('success'))
                        ...
                        @endif
                        <form data-parsley-validate action="{{route('reporter.update', $reporter->id)}}" enctype="multipart/form-data" id="regiterForm" method="post" >
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="mobile" pattern="/(01)\d{9}/" name="mobile" value="{{ ($reporter) ? $reporter->mobile : old('mobile')}}" placeholder="Enter Mobile Number" data-parsley-required-message = "Mobile number is required" class="form-control">
                                      <span id="mobile"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="email" onblur="checkField(this.value, 'email')"  onkeyup ="checkField(this.value, 'email')" name="email" value="{{ ($reporter) ? $reporter->email : old('email')}}" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-zA-Z]{2,4}" placeholder="Enter Email Address"  class="form-control">
                                      <span id="email"></span>
                                      @if ($errors->has('email'))
                                            <span class="error" role="alert">
                                                {{ $errors->first('email') }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <a href="{{asset('upload/attach/'. $reporter->userinfo->national_attach)}}"><i class="fa fa-eye"></i> View NID/Passport/Driving Licence</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <a href="{{asset('upload/attach/resume/'. $reporter->userinfo->resume)}}"><i class="fa fa-eye"></i> View Bio Data</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button id="submitBtn" class="btn btn-block btn-lg btn-info btn-rounded" type="submit">Update now</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script type="text/javascript">
        function checkField(value, field){
            ...
            if(value != ""){
                ...
                $('#'+field).html("<span style='color:red'>"+field +"</span>");
