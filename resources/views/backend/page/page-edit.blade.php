...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="padding: 0 10px !important;">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('page.update') }}" enctype="multipart/form-data" method="post" id="page">
                        @csrf
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="page_dsc" class="form-control summernote" rows="5">{{ $data->page_dsc }}</textarea>
                                            </div>
                                        </div>
                                        <div  class="col-md-12">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <span class="required">Meta keywords( <span style="font-size: 12px;color: #777;font-weight: initial;">Write meta tags Separated by Comma[,]</span> )</span>
                                                     ...
                                                     <div class="tags-default">
                                                        <input class="form-control" type="text" name="keywords[]" value="{{ $data->keywords }}" data-role="tagsinput" placeholder="Enter meta keywords" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
