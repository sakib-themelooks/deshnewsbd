                                    ...
                                    <table  class="table table-bordered table-striped">
                                        ...
                                        <tbody id="positionSorting" data-table="homepage_section_items">
                                            ...
                                            <tr style="background:{{$data->background_color}};color: {{$data->text_color}}" id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    <?php $subcategories = App\Models\Category::whereIn('id', json_decode($data->item_id))->get(); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="category_id[]" id="category_id" multiple class=" selectpicker form-control custom-select">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="background_color" id="background_color" value="#fff" class="form-control gradient-colorpicker" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="lazyload" class="form-control">
