...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <select required onchange="sectionType(this.value, 'edit')" name="section_type" class="form-control">
                ...
                <option  @if($section->section_type == 'services') selected @endif value="services">Services</option>
                
                <option  @if($section->section_type == 'category') selected @endif value="category">Categories</option>
                <option  @if($section->section_type == 'category-tab') selected @endif value="category-tab">Category Tab</option>
                ...
                <option @if($section->section_type == 'contact-form') selected @endif value="contact-form">Contact form</option>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>columns</label>
            <input type="text" class="form-control" value="{{$section->columns}}" name="columns">
        </div>
    </div> 
    <div class="col-md-3">
        <div class="form-group">
            <label>Box</label>
            <input type="text" class="form-control" value="{{$section->box}}" name="box">
        </div>
    </div>
