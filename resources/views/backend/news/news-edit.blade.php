...
@section('css')
    ...
    <style>
        ...
        .dropify_image_area{
            top: -14px;left: 12px;background:#fff;padding: 3px;
        }
        .bootstrap-tagsinput{
            width: 100% !important;
            padding: 5px;
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">আপডেট করুন </h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="{{route('news.list')}}" class="btn btn-info btn-sm d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> নিউজ লিস্ট</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('news.update', $get_news->id)}}" enctype="multipart/form-data"  method="post" id="news">
                        @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="news_title">Enter the news headline</label>
                                        ...
                                        <div class="form-group">
                                            <span for="meta_title">Sub title 1</span>
                                            <input type="text" value="{{ $get_news->sub_1 }}"  name="sub_1" id="sub_1" placeholder = 'Enter meta title'class="form-control" >
                                        </div>
                                        
                                        <div class="form-group">
                                            <span for="meta_title">Sub title 2</span>
                                            <input type="text" value="{{ $get_news->sub_2 }}"  name="sub_2" id="sub_2" placeholder = 'Enter meta title'class="form-control" >
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="news_dsc" class="form-control editor" id="news_dsc" rows="3">{!! $get_news->news_dsc  !!}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    <span for="meta_title">মেটা টাইটেল</span>
                                ...
                                <div class="col-md-3 sticky-conent">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="location[]" multiple id="location" class="selectpicker form-control custom-select">
                                                    ...
                                                    @foreach($divisions as $division)
                                                        <option value="{{$division->id}}" @if($get_news->location && in_array($division->id, json_decode($get_news->location))) selected @endif>{{$division->name_bd}}</option>
                                                            @foreach($division->subLocations as $zilla)
                                                           <option @if($get_news->location && in_array($zilla->id, json_decode($get_news->location))) selected @endif value="{{$zilla->id}}">-{{$zilla->name_bd}}</option>
                                                            @foreach($zilla->subLocations as $upzilla)
                                                            <option @if($get_news->location &&  in_array($upzilla->id, json_decode($get_news->location))) selected @endif value="{{$upzilla->id}}">--{{$upzilla->name_bd}}</option>
                                                            @endforeach
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="news_type" id="news_type" class="form-control custom-select">
                                                   <option @if($get_news->news_type == '') selected @endif value="">None</option>
                                                   <option @if($get_news->news_type == 'fa-facebook') selected @endif value="fa-facebook">Facebook</option>
                                                   <option @if($get_news->news_type == 'fa-twitter') selected @endif value="fa-twitter">Twitter</option>
                                                   <option @if($get_news->news_type == 'fa-file-image-o') selected @endif value="fa-file-image-o">Gallery</option>
                                                   <option @if($get_news->news_type == 'fa-picture-o') selected @endif value="fa-picture-o">Image</option>
                                                   <option @if($get_news->news_type == 'fa-play') selected @endif value="fa-play">Video</option>
                                                   <option @if($get_news->news_type == 'fa-music') selected @endif value="fa-music">Audio</option>
                                                   <option @if($get_news->news_type == 'fa-file-text-o') selected @endif value="fa-file-text-o">Document</option>
                                                   <option @if($get_news->news_type == 'fa-file') selected @endif value="fa-file">Aside</option>
                                                   <option @if($get_news->news_type == 'fa-quote-left') selected @endif value="fa-quote-left">Quote</option>
                                                   <option @if($get_news->news_type == 'fa-commenting-o') selected @endif value="fa-commenting-o">Status</option>
                                                   <option @if($get_news->news_type == 'fa-comments') selected @endif value="fa-comments">Chat</option>
                                                   <option @if($get_news->news_type == 'fa-link') selected @endif value="fa-link">Link</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                           <div class="form-group">
                                                <span for="user_id">Reporter</span>
                                                <select name="user_id"  id="user_id" class="form-control custom-select select2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="userx">Custom Reporter</label>
                                                <input type="text" value="{{$get_news->userx}}"  name="userx" id="userx" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <input type="text" value="{{$get_news->thumb_image_caption}}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" value="{{$get_news->captured_by}}" name="captured_by"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$get_news->thumb_url}}"  name="thumb_url" id="thumb_url" class="form-control" >
                                            </div>
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="thumb_name">YouTube video ID</label>
                                                <input type="text" value="{{$get_news->thumb_name}}"  name="thumb_name" id="thumb_name" class="form-control" >
                                            </div>
                                        </div>
                        ...
                        <div class="form-actions pull-right" style="float: right;">
                            <button type="submit" id="uploadBtn" name="submit" value="update" class="btn btn-success"> <i class="fa fa-save"></i> Update now</button>
                            <button type="submit"  name="submit" value="draft" class="btn btn-info"> <i class="fa fa-archive"></i> Draft</button>
    ...
    <script type="text/javascript">
        ...
        function getSlug(slug) {
            ...
            $.ajax({
                url:url,
                method:"get",
                data:{slug:slug,table:'news',field:'news_slug'},
