        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Update Service</h4>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('service.update', $service->id)}}" enctype="multipart/form-data" method="post" id="page">
                        @csrf
                        ...
                        <div class="form-body">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onchange="getSlug(this.value)" value="{{$service->title}}" placeholder="Enter page name" name="title" required="" id="title" class="form-control" >
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea required="" name="description" class="summernote form-control" id="description" rows="5">{{$service->description}}</textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <select required name="service" class="form-control">
                                            ...
                                            <option @if($service->service_id == $serviceType->id) selected @endif value="{{$serviceType->id}}">{{$serviceType->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                               ...
                               <div class="col-md-10"><br/>
                                    ...
                                    <div  >  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$service->meta_title}}"  name="meta_title" id="meta_title" placeholder = 'Enter meta title'class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label class="required">Meta Keywords( <span style="font-size: 12px;color: #777;font-weight: initial;">Write meta tags Separated by Comma[,]</span> )</label>
                                             ...
                                             <div class="tags-default">
                                                <input  type="text"  value="{{$service->keywords}}" name="keywords[]"  data-role="tagsinput" placeholder="Enter keywords" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="meta_description">Meta Description</label>
                                            <textarea class="form-control" name="meta_description" id="meta_description" rows="2" style="resize: vertical;" placeholder="Enter Meta Description">{{$service->meta_description}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" data-default-file="{{asset('upload/images/service/'.$service->meta_image)}}" class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpeg jpg png gif" name="meta_image" id="input-file-events">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="switch-box" style="top:-12px;">Status</label>
                                            ...
                                            <div class="custom-control custom-switch">
                                              <input checked="" name="status" {{($service->status == 1) ?  'checked' : ''}} type="checkbox" class="custom-control-input" id="status">
                            ...
                            <div class="form-actions pull-right">
                                <button type="submit"  name="submit" value="save" class="btn btn-success"> <i class="fa fa-save"></i> Update service</button>
