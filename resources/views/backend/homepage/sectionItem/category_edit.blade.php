...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group"> 
            ...
            <input data-default-file="{{asset('upload/images/homepage/'.$section->title_img)}}" type="file" class="dropify" accept="image/*" data-type='image' data-allowed-file-extensions="jpg jpeg png gif"  data-max-file-size="10M"  name="title_img" id="input-file-events">
    ...
    <div class="col-md-6">
        ...
        <textarea name="codex" class="form-control" placeholder="Enter details" id="codex" rows="9" value="{{$section->codex}}">{{$section->codex}}</textarea>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select required name="device" class="form-control">
                <option value="isDesktop"  @if($section->device == 'isDesktop') selected @endif>Desktop</option>
                <option value="isMobile"  @if($section->device == 'isMobile') selected @endif>Mobile</option>
                <option value="isTablet"  @if($section->device == 'isTablet') selected @endif>Tablet</option>
                <option value="isiPhone"  @if($section->device == 'isiPhone') selected @endif>iPhone</option>
                <option value="isAndroidOS"  @if($section->device == 'isAndroidOS') selected @endif>Android</option>
            </select>
        </div>
    </div>
    <div class="col-md-3">
