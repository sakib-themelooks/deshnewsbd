                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr id="item{{$task->id}}">
                                                            ...
                                                            <td><p class="userList">@if(Request::segment(3) == 'inbox') {{$task->workingTaskFrom->name}} @else @if(count($task->workingTaskUsers)>0) @foreach($task->workingTaskUsers as $taskUser) @if($taskUser->taskUser) {{$taskUser->taskUser->name}}, @endif @endforeach @else All Staff @endif @endif</p></td>
                                                            <td><a href="{{route('reporter.workingTaskDetails', $task->slug)}}"> {{Str::limit($task->subject, '50')}}</a></td>
                                                            <td><a href="{{route('reporter.workingTaskDetails', $task->slug)}}">{!! Str::limit(strip_tags($task->details), 60) !!} @if($task->attachment) <br/><i class="ti-link"></i> Attachment @endif</a></td>
