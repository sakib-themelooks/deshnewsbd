    ...
    <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    @if($taskDetails->workingTaskUsers && count($taskDetails->workingTaskUsers)<=1 && $taskDetails->workingTaskUsers[0]->user_id != 0)
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a onclick="return confirm('Are you sure task completed?')" href="{{route('reporter.workingTaskStatus', [$taskDetails->slug])}}" class="btn btn-success d-none d-lg-block m-l-15"><i class="fa fa-check"></i> Task Completed</a>
                        </div>
                    </div>
                    @endif
                </div>
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-xlg-2 col-lg-3 col-md-4 ">
                                    @include('reporter.working-task.leftsidebar')
                                </div>
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light border-left">
                                    <div class="card-body">
                                        <div class="card b-all shadow-none">
                                            <div class="card-body">
                                                <h3 class="card-title m-b-0">{{$taskDetails->subject}}</h3>
                                            ...
                                            @if(!Request::segment('6') == 'conversation')
                                            <div class="card-body">
                                                {!! $taskDetails->details!!}
                                                ...
                                                <p class="p-b-20">Click here to <a href="{{route('reporter.workingTaskDetails', [$taskDetails->slug, 'conversation'])}}">Reply</a></p>
                                            </div>
                                            @else
                                            <div class="card-body">
                                                <div class="b-all">
                                                            ...
                                                            <div class="chat-right-aside conversation-history" style="width:100%">
                                                                <div class="chat-rbox">
                                                                    <ul class="chat-list p-3">
                                                                        ...
                                                                        @if($taskConversation->from_user == Auth::guard('reporter')->id())
                                                                        <li class="reverse">
                                                                ...
                                                                <div class="card-body border-top">
                                                                    ...
                                                                    <form action="{{route('reporter.workingTaskConversation')}}" enctype="multipart/form-data" method="post" id="workingTaskConversation">
                                                                        @csrf
                                                                        <input type="hidden" name="task_id" value="{{$taskDetails->id}}">
                                                                        <div style="position:relative">
                                                                            <textarea name="message" id="message" required placeholder="Type your message here" class="message-box border-0"></textarea>
...
<script type="text/javascript">
    $('.conversationBtnfsdfd').click(function(){
          $.ajax({
            url:'{{route("reporter.workingTaskConversation")}}',
            type:'get',
