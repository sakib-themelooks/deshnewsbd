                                        ...
                                        <tbody>
                                            ...
                                            <tr id="item{{$show_news->id}}" @if($show_news->status == 'reject') style="background:#ff000026" @endif>
                                               ...
                                               <td><img src="{{asset('upload/images/thumb_img/'.$show_news->source_path)}}" width="100"></td>
                                                <td><a href="{{route('newsDetails', [$show_news->news_slug, $show_news->id])}}" target="_blank">{{Str::limit($show_news->news_title, 40)}}</a> </td>
                                                ...
                                                @if(in_array('editor', explode(',', Auth::guard('reporter')->user()->permission)))
                                                <td>
                                                    <a target="_blank" href="{{route('reporter.news.edit', $show_news->news_slug)}}"   title="Edit" class="dropdown-item"><i class="ti-pencil" aria-hidden="true"></i> Edit</a>
                                                </td>
                                                @endif
                                                <td>
